...
export default function Dashboard() {
  ...
  const fetchData = useCallback(() => {
    ...
    axios
      .get(`${API}/api/user/rooms/${room_id}/songs`, { headers })
      .then((r) => setSongs(r.data))
      .catch(console.error);

    axios
      .get(`${API}/api/user/rooms/${room_id}`, { headers })
    ...
    <div className="min-h-screen bg-muzix-bg text-white">
      ...
      <header className="sticky top-0 z-20 bg-muzix-bg/80 backdrop-blur-xl border-b border-white/8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center justify-between gap-4">
          <div>
            <span className="text-xs font-semibold text-muzix-muted uppercase tracking-widest">
              Now in
            </span>
            <h1
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="font-mono text-muzix-cyan truncate max-w-[80px] sm:max-w-[140px]">
                {room_id}
              </span>
              <span>{copied ? "✓" : "⎘"}</span>
            </button>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {isAdmin && (
          <div className="mb-6 bg-muzix-card border border-white/8 rounded-2xl p-5">
            <p className="text-xs font-semibold text-muzix-muted uppercase tracking-widest mb-3">
              Add a Song
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-muzix-card border border-white/8 rounded-2xl p-5">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-xs text-muzix-muted">
            ...
            {songs.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-16 text-center">
                ...
                {isAdmin && (
                  <p className="text-muzix-muted text-xs mt-1">
                    Add a YouTube link above to get started.
                  </p>
                )}
                {!isAdmin && (
                  <p className="text-muzix-muted text-xs mt-1">
                    The admin will add songs.
                  </p>
                )}
              </div>
            ) : (
          ...
          {/* Player */}
          <div className="bg-muzix-card border border-white/8 rounded-2xl p-5">
            <p className="text-xs font-semibold text-muzix-muted uppercase tracking-widest mb-4">
              Now Playing
            </p>
            ...
            {videoId ? (
              <div>
                ...
                <div className="flex items-start justify-between gap-2">
                  <div>
                    ...
                    <p className="text-xs text-muzix-muted mt-0.5">
                      Top voted song
                    </p>
                  </div>
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-slate-400 text-sm">
                  Waiting for songs in the queue…
                </p>
              </div>
            )}
          </div>
