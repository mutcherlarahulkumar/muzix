...
export default function Joinroom() {
  ...
  const handleJoin = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.message || 'Room not found. Check the ID and try again.');
      setLoading(false);
    }
  };
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="bg-muzix-card border border-white/8 rounded-2xl p-8 shadow-card">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Ask your friend for the room ID</p>
          </div>
          ...
          <div className="mb-5">
            <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5">Room ID</label>
            <input
              type="text"
